...
class UtilityFunction(object):
    ...
    def __init__(self, kind, kappa, xi, omega):
        """
        ...
        if kind not in ['ucb', 'ei', 'poi','lcb','weightedei']:
            err = "The utility function " \
                  "{} has not been implemented, " \
                  "please choose one of ucb, ei, lcb, weightedei or poi.".format(kind)
    ...
    def utility(self, x, gp, y_max):
        ...
        if self.kind == 'weightedei':
            return self._weightedei(x, gp, y_max, self.xi, self.omega)
    ...
    def _lcb(x, gp, kappa):
        ...
        return (y_mean.ravel() + kappa*y_std.ravel())
